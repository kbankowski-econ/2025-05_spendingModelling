...
%vertModelComparison(resultsProc, ["yd", "C", "Ip", "Ig", "Cg", "Ige", "Cgrd", "H", "Lab", "E", "effshock", "effgeshock"], ["Model_HumanCapital_epsi_cge", "EM_Model_HumanCapital_epsicge"], 'epsi_ige');;

%%

for aModel = modelList
    vertModelComparison(resultsProc, ["yd", "C", "Ip", "Ig", "Cg", "Ige", "Cgrd", "H", "Lab", "E", "effshock", "effgeshock"], [aModel], char(aModel));
end
...
varList = ["yd", "C", "Ip", "Ig", "Cg", "Ige", "Cgrd", "H", "Lab", "E", "effshock", "effgeshock", "TFP", "ZZRD", "AAt"]
