...
%%
panelContributionsManyModels(contributionSeries, project_path)
...
function panelContributionsManyModels(contributionSeriesAllModels, projectPath)

    % Specify the model
    contributionSeries = contributionSeriesAllModels.("Model_HumanCapital_epsi_ig");
