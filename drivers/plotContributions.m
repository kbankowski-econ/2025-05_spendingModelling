...
for aItem = aItemList
    [ ...
        ...
        , contributionSeries.lhs.(aItem) ...
            ...
            char(aItem) ...
            , utils.subroutines.Series2Dseries(resultsProc.("Model_HumanCapital_epsi_ig").endo) ...
            , utils.subroutines.Series2Dseries(resultsProc.("Model_HumanCapital_epsi_ig").ss) ...
        );
...
% panelContributionsSlide(contributionSeries, projectPath, subProjectPath);
...
function panelContributions(contributionSeries, projectPath, subProjectPath)
    ...
    exportgraphics(t, sprintf('%s.eps',fileName),'BackgroundColor','none');
end

function panelContributionsSlide(contributionSeries, projectPath, subProjectPath)
    ...
    % Save graph
    fileName = fullfile(projectPath, subProjectPath, "docs/ImplementPresentMMBseminar/figures", "fiscalContributions");
