...
% Append the seven-step Gc-shock simplification ladder (not in shockDict; added
% directly in runModel.m) and the independently coded canonical control.
modelList = [modelList, "Model_Simple1_exp_gc", "Model_Simple2_exp_gc", "Model_Simple3_exp_gc", "Model_Simple4_exp_gc", "Model_Simple5_exp_gc", "Model_Simple6_exp_gc", "Model_Simple7_exp_gc", "Model_NK_exp_gc", ...
    "Model_Simple1_exp_gc_perm", "Model_Simple2_exp_gc_perm", "Model_Simple3_exp_gc_perm", "Model_Simple4_exp_gc_perm", "Model_Simple5_exp_gc_perm", "Model_Simple6_exp_gc_perm", "Model_Simple7_exp_gc_perm", "Model_NK_exp_gc_perm", ...
    "Model_HumanCapital_exp_gc_perm", "Model_HumanCapital_exp_igi_perm", "Model_HumanCapital_exp_ige_perm", "Model_HumanCapital_exp_grd_perm", ...
    "EM_Model_HumanCapital_exp_gc_perm", "EM_Model_HumanCapital_exp_igi_perm", "EM_Model_HumanCapital_exp_ige_perm", ...
    "Model_HumanCapital_effgi_perm", "Model_HumanCapital_effge_perm", "Model_HumanCapital_effgrd_perm", ...
    "EM_Model_HumanCapital_effgi_perm", "EM_Model_HumanCapital_effge_perm", ...
    "Model_HumanCapital_exp_igi_perm025", "Model_HumanCapital_exp_ige_perm025", "Model_HumanCapital_exp_grd_perm025", ...
    "Model_HumanCapital_effgi_perm025", "Model_HumanCapital_effge_perm025", "Model_HumanCapital_effgrd_perm025", ...
    "EM_Model_HumanCapital_effgi_perm025", "EM_Model_HumanCapital_effge_perm025"];
...
varList = ["yd", "C", "Ip", "Kp", "Kg", "Kge", "Igi", "Gc", "Ige", "Grd", "G", "H", "L", "N", "E", "eGI", "eGE", "Z", "A", "mc", "w"]
