...
% Each params entry is {baseName[, overrides]} and is written to
% <name>.paramValues: without overrides a plain include of
% <baseName>_parameters.macro; with overrides a copy of the base macro
% with the overridden assignment lines replaced, so every parameter is
