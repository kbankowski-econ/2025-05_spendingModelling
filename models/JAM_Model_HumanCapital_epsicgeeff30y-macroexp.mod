...
alphaG=0.2;                          % share of public capital in production         | EM: 0.2
gss=1.004;                          % steady-state gross quarterly growth (1.6%/yr) | EM: 1.0075
% taxes and debt
...
Gcy=0.14;                            % public consumption                            | EM: 0.14
Igey=0.02;                           % human-capital-related spending                | EM: 0.02
Grdy=0.001;                         % R&D spending                                  | EM: 0.001
% human capital
mu=0.25;                         % elasticity of HC formation w.r.t. public HRC  | EM: 0.25
% R&D and technology adoption
eGRD_ss=0.2;                         % public R&D efficiency gap (e^GRD)              | EM: 0.2
alphaRD=0;                           % effect of R&D on TFP                          | EM: 0
alphaHA=0;                           % HC elasticity in tech creation (paper a_HA)   | EM: 0
varsigma=0.1;                       % adoption elasticity                           | EM: 0.1
