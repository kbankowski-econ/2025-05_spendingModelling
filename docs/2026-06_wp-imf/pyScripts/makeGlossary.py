...
PARAMETERS = [
    ...
    ("--","Consumption-tax response to the output gap",   "gamma_y_tauc"),
    ...
    ("--","Labor-tax response to the output gap",         "gamma_y_tauw"),
    ...
    ("--",           "Government-consumption persistence",           "rho_Gc"),
    ("--",        "Infrastructure-investment persistence",        "rho_Igi"),
    ...
    ("--",        "Human-capital-spending persistence",           "rho_Ige"),
