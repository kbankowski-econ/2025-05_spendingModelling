...
supply rises persistently (+0.3 percent). Both are disinflationary. This is why
the government-consumption shock is nearly price-neutral (about 0.05 percentage
...
investment rises strongly. Installing that private capacity is current demand.

The appendix "Government Consumption: Robustness to Model Structure" makes the
...
The supply-side intuition does appear in the reported results.

Within the permanent infrastructure path: inflation peaks around year 5 (0.33
percentage point) and then falls steadily (0.15 by year 25) as capacity comes
online. The supply effect increasingly offsets the demand pressure.

In the temporary shock (very clearly): under the persistent AR(1) expansion,
infrastructure inflation crosses below government consumption around year 10
and turns outright negative from about year 15.
