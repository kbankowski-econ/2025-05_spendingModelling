...
\texttt{markupss}) enters. Notation is the paper's throughout.\footnote{An earlier
version of this note carried a fixed cost of production $\Theta$ through the
derivation; the parameter was calibrated to zero and has since been removed from
the model and the paper entirely.}
...
\eqref{eq:pricing} is the same equation as \eqref{eq:fdN}, read the other way
