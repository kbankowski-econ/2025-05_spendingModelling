...
T-STEADY\_STATE(T) = (1-debtfin)*(rho\_T*(T(-1)-STEADY\_STATE(T))\\
...
\texttt{debtfin} equals one throughout the spending path and holds transfers at
their steady-state value; it returns to zero afterward so the transfer feedback
