...
\begin{figure}[htbp]
  ...
  \fignote{General government expenditure and debt profiles. SACU represents the simple (unweighted) average of the five member countries. AEs and EMs represent the medians of advanced and emerging market economies, respectively. SSA represents the weighted average of Sub-Saharan African countries, weighted by GDP in USD.}
\end{figure}
