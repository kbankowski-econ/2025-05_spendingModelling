...
Spending-efficiency differences place SACU countries far apart in international
comparisons. Figure~\ref{fig:infra-dist} sets these gaps in global context, plotting the
...
In education (bottom panel), the picture is more mixed: South Africa and Namibia sit in the
upper quartile of the global gap distribution, while Botswana, Lesotho, and Eswatini are
closer to the global median.
