...
\begin{figure}[htbp]
  ...
  \figsource{IMF staff estimates.}
  \fignote{Solid lines show the five SACU countries; dotted lines show reference
  averages---global, advanced economies (AEs), emerging markets (EMs), and
  sub-Saharan Africa (SSA). Hollow circles mark 2000 and 2023.}
\end{figure}
