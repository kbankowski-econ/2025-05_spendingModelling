...
markets, and sub-Saharan Africa. The findings for each of the three spending categories are discussed below:
...
2023, with Lesotho's dramatic improvement from a gap close to 0.9 (0.88) to about 0.4 (0.42)
being the most striking. Even so, the SACU average (0.39 in 2023) remains above the
...
education efficiency gaps of 0.31 to 0.44 across SACU, with limited change
between 2000 and 2023 for most countries (though Lesotho's gap narrowed notably
from 0.44 to 0.33) and South Africa and Namibia ending modestly above their 2000
levels.
