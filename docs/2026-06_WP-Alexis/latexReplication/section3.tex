...
% Hanging-indent entry for the manual reference list.
\newcommand{\refitem}[1]{\noindent\hangindent=1.5em\hangafter=1 #1\par\medskip}
...
Ba\'nkowski, Cho, and Sher (2026), which underpin the October 2025 Fiscal
Monitor (IMF 2025f). Their approach compares public spending (the input) with
...
from statistical noise. Persistent structural differences between
countries---such as being landlocked or having a large private health
sector---are handled separately, through the four-component (``true random
effects'') estimator of Filippini and Greene (2016), which distinguishes
time-invariant structural heterogeneity from persistent inefficiency so that the
former is not mislabelled as the latter.
...
indicators. The procedure yields, for each country and year, an efficiency score
between 0 and 1, with 1 denoting a country on the frontier. Throughout this
...
shortfalls. Full methodological detail is given in Ba\'nkowski, Cho, and Sher
(2026) and the Fiscal Monitor Online Annex (IMF 2025g).
...
\refitem{Ba\'nkowski, Krzysztof, Chloe Hyungsun Cho, and Galen Sher. 2026.
``Public Spending Efficiency.'' Unpublished.}

\refitem{Filippini, Massimo, and William Greene. 2016. ``Persistent and
Transient Productive Inefficiency: A Maximum Simulated Likelihood Approach.''
\emph{Journal of Productivity Analysis} 45 (2): 187--196.}

\refitem{IMF. 2025f. \emph{Fiscal Monitor: Spending Smarter---How Efficient and
Well-Allocated Public Spending Can Boost Economic Growth.} International Monetary
Fund, Washington, DC, October.}

\refitem{IMF. 2025g. \emph{Fiscal Monitor Online Annex: Methodological
Sections.} International Monetary Fund, Washington, DC, October.}

\refitem{IMF. 2026. ``Spending Smarter in SACU: Diagnosis, Modelling, and Policy
Implications.'' Staff presentation, African Department, International Monetary
