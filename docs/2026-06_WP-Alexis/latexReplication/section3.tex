...
\begin{figure}[H]
  \centering
  \caption{Public-Sector Debt and Expenditure Dynamics in SACU}
  \label{fig:debt-dynamics}
  \subcap{General government gross debt and total expenditure, percent of GDP, 2000--25}
  \vspace{4pt}
  \includegraphics[width=\textwidth]{figure_debt_dynamics.png}
  \figsource{IMF staff estimates based on the IMF World Economic Outlook database.}
  \fignote{General government expenditure and debt profiles. SACU represents the simple (unweighted) average of the five member countries. The members differ greatly in size: measured by nominal GDP in US dollars (2025), South Africa accounts for about 91 percent of SACU GDP, followed by Botswana (4 percent), Namibia (3 percent), Eswatini (1 percent), and Lesotho (under 1 percent). AEs, EMs, and SSA represent the medians of advanced economies, emerging market economies, and Sub-Saharan African countries, respectively. The shaded grey band spans the range between the lowest and highest of the five SACU countries in each year.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \caption{Public-Sector Wage Bill in SACU}
  \label{fig:wage-bill}
  \subcap{SACU wage bills are well above peer groups}
  \vspace{4pt}
  \includegraphics[width=\textwidth]{figure_wage_share.png}
  \figsource{IMF staff estimates based on the IMF FAD Government Compensation and Employment Dataset.}
  \fignote{Wage bill as a share of total expenditure. SACU represents the simple (unweighted) average of the five member countries; thin solid lines show the individual countries. AEs, EMs, and SSA represent the medians of advanced economies, emerging market economies, and Sub-Saharan African countries, respectively. The shaded grey band spans the range between the lowest and highest of the five SACU countries in each year.}
\end{figure}

A second feature compounds the level effect: the public-private wage premium. Figure~\ref{fig:wage-premium} plots, for each country in the IMF Government-Private Sector Compensation Premium Dataset, the percentage by which public-sector compensation exceeds private-sector compensation for workers of comparable qualifications. In SACU, the premium ranges between about 30 percent (Lesotho) and around 50 percent (South Africa, Eswatini, Botswana). These are among the highest premia observed globally. The combination of a large public payroll and a high premium implies that the fiscal envelope devoted to wages does less work per currency unit than it would in a better-calibrated system.

\begin{figure}[H]
  \centering
  \caption{Public Wage Premium in SACU}
  \label{fig:wage-premium}
  \subcap{Public wage premia in SACU are among the largest observed}
  \vspace{4pt}
  \includegraphics[width=\textwidth,height=6.68cm]{figure_wage_bill_premiumOnly.png}
  \figsource{Reproduced from \textcite{imf2026sacu}, based on the IMF Government-Private Sector Compensation Premium Dataset.}
  \fignote{Percentage by which public-sector compensation exceeds private-sector compensation for workers of comparable qualifications. Each point is one country; horizontal bars mark group means. SACU members are labelled individually.}
\end{figure}
