...
\begin{frame}{Calibration of Spending-Efficiency Gaps}
    ...
    \begin{tabular}{l c c c}
        ...
        \midrule
        Infrastructure & 0.350 & 0.415 & 0.136 \\
        \addlinespace[0.4em]
        \quad Health    & 0.280 & 0.295 & 0.362 \\
        \quad Education  & 0.310 & 0.345 & 0.371 \\
        \textbf{Human capital} (average) & \textbf{0.295} & \textbf{0.320} & \textbf{0.366} \\
        \bottomrule
    \end{tabular}
    \end{center}
    ...
    {\fontsize{6pt}{7.5pt}\selectfont
        ...
        Notes: Spending-efficiency gaps (one minus the efficiency score) entering the model calibration. The human-capital gap is the simple average of the health and education gaps. EMDE figures are themselves averages across emerging-market and low-income economies (e.g.\ infrastructure $0.415 = (0.37+0.46)/2$). Jamaica uses its latest available estimates: infrastructure and health from 2023, education from 2024. \\
    }
\end{frame}
