...
\begin{frame}{Spending Efficiency Gaps: Jamaica versus Emerging Markets}
    ...
    {\fontsize{5pt}{6pt}\selectfont
        ...
        Notes: Spending-efficiency gaps over time. Shaded bands show the 25th--75th percentile across emerging-market economies and the dotted line the emerging-market median; the solid blue line is Jamaica. Circles mark the 2023 values (the reference year for the calibration) on the emerging-market median and on Jamaica; only Jamaica's value is labelled. A larger gap means more room for efficiency-led output gains: Jamaica's infrastructure gap (0.14) lies well below the emerging-market range, whereas its health and education gaps are close to the median. \\
    }
\end{frame}
