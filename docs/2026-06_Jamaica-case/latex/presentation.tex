...
\begin{frame}{Spending Efficiency Gaps: Jamaica versus Emerging Markets}
    ...
    {\fontsize{5pt}{6pt}\selectfont
        ...
        Notes: Spending-efficiency gaps over time. Shaded bands show the 25th--75th percentile across emerging-market economies; the dotted line is the emerging-market median; the blue line is Jamaica, with its latest available estimate marked (infrastructure and health 2023, education 2024). A larger gap indicates more room for efficiency-led output gains. Jamaica's infrastructure gap (0.14) lies well below the emerging-market range, whereas its health and education gaps are close to the median. \\
    }
\end{frame}
