...
\begin{frame}{Calibration of Spending-Efficiency Gaps}
    ...
    \begin{tabular}{l c c c}
        ...
        \midrule
        Infrastructure & 0.350 & \cellcolor{gray!20}$(0.37+0.46)/2 = 0.415$ & \cellcolor{gray!20}0.136 \\
        \addlinespace[0.4em]
        \quad {\small Health}   & {\small 0.280} & {\small $(0.30+0.29)/2 = 0.295$} & {\small 0.362} \\
        \quad {\small Education} & {\small 0.310} & {\small $(0.34+0.35)/2 = 0.345$} & {\small 0.371} \\
        Human capital (average) & 0.295 & \cellcolor{gray!20}0.320 & \cellcolor{gray!20}0.366 \\
        \bottomrule
    \end{tabular}
    \end{center}
    ...
    {\fontsize{6pt}{7.5pt}\selectfont
        ...
        Notes: Spending-efficiency gaps (one minus the efficiency score) entering the model calibration. Each EMDE cell is the average of the emerging-market and low-income group values (the two numbers shown), which match the group medians in the previous chart. The human-capital gap is the average of health and education. Jamaica uses its latest available estimates: infrastructure and health from 2023, education from 2024. \\
    }
\end{frame}
